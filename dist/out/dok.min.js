...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  function t() {
    ...
    this.lastError = null;
      ...
      x = "";return v.handleError = r, v.changeScene = e, v.destroyEverything = w, v.combineMethods = n, v.expectParams = i, v.checkParams = a, v.assert = o, v.fixPath = t, v.onDestroy = l, v.loadAsync = d, v.Roundabout = p, v.getTitle = g, v.makeArray = y, v.nop = function () {}, u(), f(), v;
  ...
  function r() {
    ...
    t && m !== w ? (m = w, u(v, m)) : t || m !== w || (m = v, u(w, m)), i();
  }function i() {
    m.quaternion.toArray(x.array), x.forwardMovement.set(0, 0, 1), x.forwardMovement.applyQuaternion(m.quaternion);
  }function a() {
    return m.quaternion.equals(b) || (i(), b.copy(m.quaternion)), x;
  }function o() {
    v.position.set(0, 0, 400), w.position.set(0, 0, 400);
  }function s() {
    return m === w;
  }function u(t, e) {
    ...
    var r = -Math.atan2(e - m.position.z, t - m.position.x) - Math.PI / 2;return A.setFromAxisAngle(F, r), A.multiply(C), A.toArray(I);
  }function c() {
    ...
    g === t && y === e || (g = t, y = e, v.left = -g / 2, v.right = g / 2, v.top = y / 2, v.bottom = -y / 2, v.updateProjectionMatrix(), w.aspect = g / y, w.updateProjectionMatrix());
  }function p() {}var g = innerWidth,
      y = innerHeight,
      m = void 0,
      v = new t.OrthographicCamera(-g / 2, g / 2, y / 2, -y / 2, .1, 1e6),
      w = new t.PerspectiveCamera(75, g / y, .1, 1e6),
      x = { array: new Float32Array(4), forwardMovement: new t.Vector3(0, 0, 1), version: 0 },
      b = new t.Quaternion(),
      A = new t.Quaternion(),
      I = new Float32Array(4),
      F = new t.Vector3(0, 1, 0),
      C = new t.Quaternion().setFromAxisAngle(new t.Vector3(1, 0, 0), -Math.PI / 2);return p.setCamera3d = n, p.isCamera3d = s, p.getCamera = r, p.setCameraPosition = f, p.getCameraPosition = l, p.getCameraQuaternionData = a, p.shadowQuatArray = h, p.quaternions = c(), p.checkWindowSize = d, o(), n(!0), p;
  ...
  function r(t) {
    ...
    var r = new Image();return r.onload = function (t) {
      e.call(r, t), p--, v++, a();
    }, r.crossOrigin = "", c.push({ image: r, url: t }), w++, a(), r;
  }function i(e, r) {
    w++, t.loadAsync(e, function (t) {
      v++, r(t);
    });
  }function a() {
    for (; h < c.length && p < d;) {
      c[h].image.src = c[h].url, h++, p++;
    }h === c.length && (h = 0, c.length = 0, v = 0, w = 0);
  }function o() {
    return w ? v / w : 1;
  }function s() {
    if (g) {
    ...
    c.length = 0;
      ...
      m = null,
      v = 0,
      w = 0;return f.loadImage = n, f.loadFile = i, f.getLoadingProgress = o, f.getLoadingBar = u, f.setOnLoad = r, t.onDestroy(l), f;
}), define("spritesheet", ["threejs", "utils", "gifhandler", "loader", "packer"], function (t, e, r, n, i) {
  "use strict";
  function a(e, r) {
    if (!w[e] && r) {
      var n = w[e] = document.createElement("canvas");if (n.setAttribute("url", e), 0 === e.indexOf("tex-")) {
        n.width = n.height = C;var i = parseInt(e.split("-").pop()),
    ...
    if (x[t] && x[t].cut[e] && x[t].cut[e].ready) return x[t];var n = u(t.split("|"), e),
        a = i.getSlot(n),
        o = x[t];if (o || (o = { index: A++, url: t, baseUrl: null, cut: [], animated: !1 }, x[t] = o, b[o.index] = o), o.cut[e] || (o.cut[e] = { tex: 0, uv: null, ready: !1, url: t, baseUrl: null }), a) {
      F[n.getAttribute("url")] = a, n.addEventListener("update", p), n.dispatchEvent(s("update"));var l = a.x / C,
          f = a.y / C,
          h = (n.width - 1) / C,
          c = (n.height - 1) / C,
          d = D.attributes.uv.array,
    ...
    return I;
      ...
      F = {},
      C = 2048,
      D = new t.PlaneBufferGeometry(1, 1);return v.getCut = h, v.getTextures = m, v.preLoad = d, v.fetchCanvas = u, v.spritesheet = {}, e.onDestroy(y), v;
    ...
    var f = t(e, r, l);if (!f.inOrder) {
      var h = f.min,
        ...
        var p = Math.min(l, a),
          ...
          y = Math.floor((p - 1) * (u(e[m]) - h) / d);var w = o[y] + --s[y];for (i(e, m, w); !s[v];) {
            v++;
          }m = o[v];
        }for (g = 0; g < p; g++) {
          s[g] = o[g + 1] - o[g];
  ...
  "use strict";
  function u() {
    this.images = [], this.imageOrder = [], this.imageCount = 0, this.mesh = h(this), this.curvature = 0, this.bigwave = 0;var t = this;this.display = function (e) {
      var r = t.imageCount,
          a = t.images[r],
    ...
    var r = new t.Mesh(c(), new t.MeshBasicMaterial());return r.material = new t.ShaderMaterial({ uniforms: C = { texture: { type: "tv", get value() {
    ...
    for (var t = this.images, e = this.imageOrder, r = this.imageCount, n = this.mesh.geometry, i = n.attributes.quaternion.array, a = n.attributes.spot.array, o = n.attributes.position.array, s = n.attributes.tex.array, u = n.attributes.light.array, l = n.attributes.wave.array, f = n.attributes.uv.array, h = n.index.array, c = !1, d = !1, p = !1, g = !1, y = !1, m = !1, v = !1, w = 0; w < r; w++) {
      var x = t[w],
          A = x.index;x.quatDirty && (x.quaternionArray.splatter(i, 16 * A), x.quatDirty = !1, c = !0), x.positionDirty && (x.spotArray.splatter(a, 12 * A), x.positionDirty = !1, d = !0), x.verticesDirty && (x.vertices.splatter(o, 12 * A), x.verticesDirty = !1, g = !0), x.uvDirty && (x.uv.splatter(f, 8 * A), x.uvDirty = !1, y = !0), x.texDirty && (s.fill(x.tex, 4 * A, 4 * A + 4), x.texDirty = !1, p = !0), x.lightDirty && (u.fill(x.light, 4 * A, 4 * A + 4), x.lightDirty = !1, m = !0), x.waveDirty && (l.fill(x.wave, 4 * A, 4 * A + 4), x.waveDirty = !1, v = !0);
    }for (var I = 0; I < r; I++) {
    ...
    function e(t, e, r) {
      ...
      for (var e = o(), n = Math.floor(e.x / f), i = Math.floor(e.y / f), a = 1, s = i - a; s <= i + a; s++) {
        for (var u = n - a; u <= n + a; u++) {
          var h = r(u, s),
              c = l[h];if (c) for (var d = Object.getOwnPropertyNames(c), p = 0; p < d.length; p++) {
            var g = c[d[p]],
                y = this.getSprite(g);Array.isArray(y) ? y.forEach(t) : t(y);
          }
        }
      }
      ...
      var r = a(t, e),
          n = l[r];if (m.length = 0, n) for (var i = Object.getOwnPropertyNames(n), o = 0; o < i.length; o++) {
  ...
  function e(t) {
    if (void 0 === t.target.attributes.tap) {
      ...
      } else d.x = t.pageX, d.y = t.pageY;x = !0;for (var r = 0; r < p.length; r++) {
        p[r](null, null, !0, t.pageX, t.pageY);
      }if (e && 2 === e.length) {
        var i = e[0].pageX - e[1].pageY,
            a = e[0].pageY - e[1].pageY,
            o = Math.sqrt(i * i + a * a);w = o;
      }
    }t.preventDefault();
  }function r(t) {
    ...
    t = t || event;var e = t.changedTouches;if (e) {
      if (x) {
        for (var r = 0, n = 0, i = 0; i < e.length; i++) {
          ...
          for (var r = e[0].pageX - e[1].pageY, n = e[0].pageY - e[1].pageY, o = Math.sqrt(r * r + n * n), s = o - w, i = 0; i < y.length; i++) {
            y[i](s);
          }w = o;
        }
      }
    } else {
      var u = "buttons" in t && 1 === t.buttons || 1 === t.button;if (u && !x && (d.x = t.pageX, d.y = t.pageY, x = !0), u && x) {
        var l = t.pageX,
            f = t.pageY,
            r = l - d.x,
    ...
    b.addEventListener("mousedown", e), b.addEventListener("touchstart", e), b.addEventListener("mouseup", r), b.addEventListener("touchend", r), b.addEventListener("touchcancel", r), b.addEventListener("mousemove", n), b.addEventListener("touchmove", n), b.addEventListener("wheel", i), b.addEventListener("mouseleave", r);
  }function l() {
    b.removeEventListener("mousedown", e), b.removeEventListener("touchstart", e), b.removeEventListener("mouseup", r), b.removeEventListener("touchend", r), b.removeEventListener("touchcancel", r), b.removeEventListener("mousemove", n), b.removeEventListener("touchmove", n), b.removeEventListener("wheel", i), b.removeEventListener("mouseleave", r);
  }function f(t) {
    l(), b = t, u();
  }function h() {
    p = [], g = [], y = [], l();
...
}), define("keyboard", ["utils", "loop"], function (t, e) {
  "use strict";
  function r() {
    n(), l = null;
  }function n() {
    document.removeEventListener("keydown", a), document.removeEventListener("keyup", a);
  }function i() {
    document.addEventListener("keydown", a), document.addEventListener("keyup", a);
  }function a(t) {
    var r = t.keyCode;"keydown" === t.type ? l[r] || (l[r] = e.time) : l[r] = 0, t.preventDefault();
  }function o(t) {
    return l[t];
  }function s() {
    var t = 0,
        e = 0;return (o(87) || o(38)) && e++, (o(83) || o(40)) && e--, (o(65) || o(37)) && t--, (o(68) || o(39)) && t++, f.x = t, f.y = e, f;
  }function u() {}var l = [],
      f = { x: 0, y: 0 };return u.getMove = s, i(), t.onDestroy(r), u;
...
}), define("dobuki", ["utils", "loop", "gifHandler", "camera", "objectpool", "spriteobject", "packer", "spritesheet", "spriterenderer", "collection", "mouse", "keyboard", "loader", "engine"], function (t, e, r, n, i, a, o, s, u, l, f, h, c, d) {
  return { Utils: t, Loop: e, GifHandler: r, Camera: n, ObjectPool: i, SpriteObject: a, SpriteSheet: s, SpriteRenderer: u, Collection: l, Mouse: f, Keyboard: h, Loader: c, Engine: d };

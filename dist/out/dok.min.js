...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  function i() {}function a(e, r, n) {
    ...
    function e(t, e, r) {
      this.uid = d++, h[this.uid] = this, this.index = r, this.enterArea(t, e);
    }function r(t, e) {
      return t = Math.floor(t / s), e = Math.floor(e / s), t + "_" + e;
    }function i() {
      var t = n.getCamera(),
          e = t.position.x,
          r = t.position.y;return p.x = Math.round(e / f), p.y = Math.round(r / f) + 6, p;
    }var o = [],
        s = 50,
        h = [],
        f = 64,
      ...
      switch (t.type) {case "face":
          ...
          return l(t);}
    };t.spriteFunction && (c = t.spriteFunction);var d = 0;e.prototype.leaveArea = function () {

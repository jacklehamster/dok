...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  function n() {
    ...
    var i = u.get();s[i] = n, f.postMessage({ frameInfo: t, cData: e, header: r, id: i }, [e.data.buffer]);
  }function o() {
    f && f.terminate(), f = null, s = null, u = null;
  }var s = [],
      u = new r(),
      l = n.toString();l = l.substring(l.indexOf("{") + 1, l.lastIndexOf("}"));var h = new Blob([l], { type: "application/javascript" }),
      f = new Worker(URL.createObjectURL(h));return i(f), f.send = a, t.onDestroy(o), f;
  ...
  function r() {
    ...
    t && g !== x ? (g = x, u(v, g)) : t || g !== x || (g = v, u(x, g)), i();
  }function i() {
    g.quaternion.toArray(w.array), w.forwardMovement.set(0, 0, 1), w.forwardMovement.applyQuaternion(g.quaternion);
  }function a() {
    return g.quaternion.equals(b) || (i(), b.copy(g.quaternion)), w;
  }function o() {
    ...
    var r = -Math.atan2(e - g.position.z, t - g.position.x) - Math.PI / 2;return A.setFromAxisAngle(F, r), A.multiply(q), A.toArray(I);
  }function c() {
    ...
    y === innerWidth && m === innerHeight || (v.left = -y / 2, v.right = y / 2, v.top = m / 2, v.bottom = -m / 2, v.updateProjectionMatrix(), x.aspect = y / m, x.updateProjectionMatrix(), y = innerWidth, m = innerHeight);
  }function p() {}var g,
      y = innerWidth,
      m = innerHeight,
      v = new t.OrthographicCamera(-y / 2, y / 2, m / 2, -m / 2, .1, 1e6),
      x = new t.PerspectiveCamera(75, y / m, .1, 1e6),
      w = { array: new Float32Array(4), forwardMovement: new t.Vector3(0, 0, 1), version: 0 },
      b = new t.Quaternion(),
      A = new t.Quaternion(),
      I = new Float32Array(4),
      F = new t.Vector3(0, 1, 0),
      q = new t.Quaternion().setFromAxisAngle(new t.Vector3(1, 0, 0), -Math.PI / 2);return p.setCamera3d = n, p.isCamera3d = s, p.getCamera = r, p.setCameraPosition = h, p.getCameraPosition = l, p.getCameraQuaternionData = a, p.shadowQuatArray = f, p.quaternions = c(), o(), n(!0), e.addLoop(d), p;
  ...
  }function n(t, e, r, n, i, a, o, s, u) {
    t.position.x = e, t.position.y = r, t.position.z = n, t.size[0] = i, t.size[1] = a, t.hasQuaternionArray = null !== o, t.hasQuaternionArray && (t.quaternionArray[0] = o[0], t.quaternionArray[1] = o[1], t.quaternionArray[2] = o[2], t.quaternionArray[3] = o[3]), t.light = s, t.img = u;
  }r.prototype.position = null, r.prototype.size = null, r.prototype.hasQuaternionArray = !1, r.prototype.quaternionArray = null, r.prototype.light = 1, r.prototype.img = -1, r.prototype.offset = null, r.prototype.visible = !0;var i = new e(r);return r.create = function (t, e, r, a, o, s, u, l) {
    var h = i.create();return n(h, t, e, r, a, o, s, u, l), h;
  }, r.clear = function () {
    i.recycleAll();
  }, r;
  ...
  function t(t, e, r) {
    for (var n = u(t[e]), i = n, a = n, o = n, s = !0, h = 1; h < r; h++) {
      var f = u(t[e + h]);o > f ? (s = !1, f < i && (i = f)) : f > a && (a = f), o = f;
    ...
    var h = t(e, r, l);if (!h.inOrder) {
      var f = h.min,
        ...
        var p = Math.min(l, a),
          ...
          y = Math.floor((p - 1) * (u(e[g + r]) - f) / d), s[y]++;
        }for (g = 0; g < p; g++) {
          o[g] = 0;
        }for (o[p] = r + l, o[0] = r, g = 1; g < p; g++) {
          o[g] = o[g - 1] + s[g - 1];
        }for (var m = r, v = 0; v < p;) {
          y = Math.floor((p - 1) * (u(e[m]) - f) / d);var x = o[y] + --s[y];for (i(e, m, x); !s[v];) {
            v++;
          }m = o[v];
        }for (g = 0; g < p; g++) {
          s[g] = o[g + 1] - o[g];
  ...
  function s() {
    this.images = [], this.imageOrder = [], this.imageCount = 0, this.mesh = h(this), this.curvature = 0;var t = this;this.display = function (e) {
      var r = null,
          a = e && e.visible ? n.getCut(e.img) : null;if (a && a.ready) {
        var o = t.imageCount;if (r = t.images[o], !r) {
          r = t.images[o] = new u(), r.index = o;for (var s = 0; s < w.length; s++) {
            r.indexArray[s] = w[s] + 4 * r.index;
          }
        }var l = e.hasQuaternionArray ? e.quaternionArray : i.getCameraQuaternionData().array;if (r.quaternionArray[0] === l[0] && r.quaternionArray[1] === l[1] && r.quaternionArray[2] === l[2] && r.quaternionArray[3] === l[3] || (l.splatter(r.quaternionArray, 0).splatter(r.quaternionArray, 4).splatter(r.quaternionArray, 8).splatter(r.quaternionArray, 12), r.quatDirty = !0), e.position.x !== r.position.x || e.position.y !== r.position.y || e.position.z !== r.position.z) {
          r.position.x = e.position.x, r.position.y = e.position.y, r.position.z = e.position.z;for (var h = 0; h < 4; h++) {
            r.spotArray[3 * h] = r.position.x, r.spotArray[3 * h + 1] = r.position.y, r.spotArray[3 * h + 2] = r.position.z;
          }r.positionDirty = !0;
        }if (e.size[0] !== r.size[0] || e.size[1] !== r.size[1] || e.size[2] !== r.size[2] || r.positionDirty) {
          r.size[0] = e.size[0], r.size[1] = e.size[1], r.size[2] = e.size[2];for (var f = v.attributes.position.array, c = 0; c < f.length; c++) {
            r.vertices[c] = f[c] * e.size[c % 3] + r.spotArray[c];
          }r.verticesDirty = !0;
  ...
  function i() {}function a(e, r, n) {
    ...
    function e(t, e, r) {
      this.uid = ++p, f[this.uid] = this, this.index = r, this.enterArea(t, e);
    }function r(t, e) {
      return Math.abs(1331 * t ^ 312 + 131 * e) % s.length;
    }function i(t, e) {
      return t = Math.floor(t / h), e = Math.floor(e / h), r(t, e);
    }function o() {
      var t = n.getCamera(),
          e = t.position.x,
          r = t.position.y;return g.x = Math.round(e / c), g.y = Math.round(r / c) + 6, g;
    }var s = [];s.length = 1e6;var h = 50,
        f = [],
        c = 64,
        d = function d(t) {
      ...
      var t = i(this.x, this.y),
          e = s[t];e && e[this.uid] && delete e[this.uid];
    }, e.prototype.enterArea = function (t, e) {
      this.x = t, this.y = e;var r = i(this.x, this.y),
          n = s[r] || (s[r] = {});n[this.uid] = this;
    }, e.prototype.move = function (t, e) {
      this.leaveArea(), this.enterArea(t, e);
    };var g = { x: 0, y: 0 },
        y = new a(t, d, function (t) {
      for (var e = o(), n = Math.floor(e.x / h), i = Math.floor(e.y / h), a = 1, u = i - a; u <= i + a; u++) {
        for (var l = n - a; l <= n + a; l++) {
          var f = r(l, u),
              c = s[f];if (c) for (var d in c) {
            var p = c[d],
      ...
      var r = i(t, e),
          n = s[r];m.length = 0;for (var a in n) {
        var o = n[a];Math.floor(o.x) === t && Math.floor(o.y) === e && m.push(o);
      }return m.length ? m : null;
    }, y.find = function (t) {
      return f[t];
    }, y;
  }a.prototype.pos = null, a.prototype.size = null, a.prototype.getSprite = i, a.prototype.forEach = o, a.prototype.options = null, a.prototype.getSprite = i, a.prototype.isCollection = !0, a.prototype.get = i, a.prototype.find = i, a.prototype.create = i;var f = [];return a.createSpriteCollection = h, t.onDestroy(s), a;
}), define("mouse", ["utils"], function (t) {
  "use strict";
  function e(t) {
    if (void 0 === t.target.attributes.tap) {
      var e = t.changedTouches;if (e) for (var r = 0; r < e.length; r++) {
        var n = e[r];y[n.identifier] = n.pageX, m[n.identifier] = n.pageY;
      } else c.x = t.pageX, c.y = t.pageY;x = !0;for (var r = 0; r < d.length; r++) {
        d[r](null, null, !0, t.pageX, t.pageY);
      }if (e && 2 === e.length) {
        var i = e[0].pageX - e[1].pageY,
            a = e[0].pageY - e[1].pageY,
            o = Math.sqrt(i * i + a * a);v = o;
      }
    }t.preventDefault();
  }function r(t) {
    var e = !1;if (t.changedTouches) {
      for (var r = t.changedTouches, n = 0; n < r.length; n++) {
        var i = r[n];delete y[i.identifier], delete m[i.identifier];
      }for (var n in y) {
        e = !0;
      }
    }for (var n = 0; n < d.length; n++) {
      d[n](null, null, e, t.pageX, t.pageY);
    }x = !1, t.preventDefault();
  }function n(t) {
    t = t || event;var e = t.changedTouches;if (e) {
      if (x) {
        for (var r = 0, n = 0, i = 0; i < e.length; i++) {
          var a = e[i];r += a.pageX - y[a.identifier], n += a.pageY - m[a.identifier], y[a.identifier] = a.pageX, m[a.identifier] = a.pageY;
        }for (var i = 0; i < d.length; i++) {
          d[i](r, n, !0, t.pageX, t.pageY);
        }if (g.length && 2 === e.length) {
          for (var r = e[0].pageX - e[1].pageY, n = e[0].pageY - e[1].pageY, o = Math.sqrt(r * r + n * n), s = o - v, i = 0; i < g.length; i++) {
            g[i](s);
          }v = o;
        }
      }
    } else {
      var u = "buttons" in t && 1 === t.buttons || 1 === (t.which || t.button);if (u && x) {
        var l = t.pageX,
            h = t.pageY,
            r = l - c.x,
            n = h - c.y;c.x = l, c.y = h;for (var i = 0; i < d.length; i++) {
          d[i](r, n, !0, t.pageX, t.pageY);
        }
      } else {
        x = !1;for (var i = 0; i < d.length; i++) {
          d[i](r, n, !1, t.pageX, t.pageY);
        }
      }
    }t.preventDefault();
  }function i(t) {
    t = t || event;for (var e = 0; e < p.length; e++) {
      p[e](t.deltaX, t.deltaY);
    }
  }function a(t) {
    l(), u(), d.push(t);
  }function o(t) {
    ...
    document.addEventListener("mousedown", e), document.addEventListener("touchstart", e), document.addEventListener("mouseup", r), document.addEventListener("touchend", r), document.addEventListener("touchcancel", r), document.addEventListener("mousemove", n), document.addEventListener("touchmove", n), document.addEventListener("wheel", i);
  }function l() {
    document.removeEventListener("mousedown", e), document.removeEventListener("touchstart", e), document.removeEventListener("mouseup", r), document.removeEventListener("touchend", r), document.removeEventListener("touchcancel", r), document.removeEventListener("mousemove", n), document.removeEventListener("touchmove", n), document.removeEventListener("wheel", i);
  }function h() {
    d = [], p = [], g = [], l();
  }function f() {}var c = { x: 0, y: 0 },
      d = [],
      p = [],
      g = [],
      y = {},
      m = {},
      v = 0,
      x = !1;return f.setOnTouch = a, f.setOnWheel = o, f.setOnZoom = s, t.onDestroy(h), f;

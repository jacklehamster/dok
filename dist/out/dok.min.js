...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  function t() {
    ...
    "undefined" == typeof e && (e = "scene.html"), x.destroyEverything(), location.replace("../" + t + "/" + e);
  }function r(t, e) {
    if (Array.isArray(t)) {
      for (var r = [], n = 0; n < t.length; n++) {
        r.push(t[n]), r.push("\n ");
      }console.error.apply(null, r);
    } else console.error(t);if (x.lastError = t, !e) throw new Error("Last error terminated the process.");
  }function n(t, e) {
    return function () {
      t && t(), e && e();
    };
    ...
    return v(Array.prototype.slice.apply(arguments));
  }function v(t) {
    ...
    this.lastError = null;
      ...
      w = "";return x.handleError = r, x.changeScene = e, x.destroyEverything = b, x.combineMethods = n, x.expectParams = i, x.checkParams = o, x.assert = a, x.fixPath = t, x.onDestroy = l, x.loadAsync = p, x.Roundabout = g, x.getTitle = y, x.makeArray = m, u(), h(), x;
  ...
  var t = function t(_t) {
    ...
    this.data = t, this.len = this.data.length, this.pos = 0, this.readByte = function () {
      ...
      n = function n(t, e) {
    for (var r, n, i = 0, o = function o(t) {
      for (var r = 0, n = 0; n < t; n++) {
        e.charCodeAt(i >> 3) & 1 << (7 & i) && (r |= 1 << n), i++;
      }return r;
    }, a = [], s = 1 << t, u = s + 1, l = t + 1, h = [], f = function f() {
      ...
      if (n = r, r = o(l), r !== s) {
        ...
        }a.push.apply(a, h[r]), h.length === 1 << l && l < 12 && l++;
      } else f();
    }return a;
  },
      i = function i(r, _i2) {
    _i2 || (_i2 = {});var o = function o(t) {
      for (var e = [], n = 0; n < t; n++) {
      ...
      var t, e;e = "";do {
        ...
        s = function s() {
      var n = {};if (n.sig = r.read(3), n.ver = r.read(3), "GIF" !== n.sig) throw new Error("Not a GIF file.");n.width = r.readUnsigned(), n.height = r.readUnsigned();var a = e(r.readByte());n.gctFlag = a.shift(), n.colorRes = t(a.splice(0, 3)), n.sorted = a.shift(), n.gctSize = t(a.splice(0, 3)), n.bgColor = r.readByte(), n.pixelAspectRatio = r.readByte(), n.gctFlag && (n.gct = o(1 << n.gctSize + 1)), _i2.hdr && _i2.hdr(n);
    },
        u = function u(n) {
      var o = function o(n) {
        var o = (r.readByte(), e(r.readByte()));n.reserved = o.splice(0, 3), n.disposalMethod = t(o.splice(0, 3)), n.userInput = o.shift(), n.transparencyGiven = o.shift(), n.delayTime = r.readUnsigned(), n.transparencyIndex = r.readByte(), n.terminator = r.readByte(), _i2.gce && _i2.gce(n);
      },
          s = function s(t) {
        t.comment = a(), _i2.com && _i2.com(t);
      },
          u = function u(t) {
        r.readByte();t.ptHeader = r.readBytes(12), t.ptData = a(), _i2.pte && _i2.pte(t);
      },
          l = function l(t) {
        var e = function e(t) {
          r.readByte();t.unknown = r.readByte(), t.iterations = r.readUnsigned(), t.terminator = r.readByte(), _i2.app && _i2.app.NETSCAPE && _i2.app.NETSCAPE(t);
            ...
            n = function n(t) {
          t.appData = a(), _i2.app && _i2.app[t.identifier] && _i2.app[t.identifier](t);
        };r.readByte();switch (t.identifier = r.read(8), t.authCode = r.read(3), t.identifier) {case "NETSCAPE":
            e(t);break;default:
            n(t);}
      },
          h = function h(t) {
        t.data = a(), _i2.unknown && _i2.unknown(t);
      };switch (n.label = r.readByte(), n.label) {case 249:
          n.extType = "gce", o(n);break;case 254:
      ...
      var u = function u(t, e) {
        for (var r = new Array(t.length), n = t.length / e, i = function i(n, _i) {
          var o = t.slice(_i * e, (_i + 1) * e);r.splice.apply(r, [n * e, e].concat(o));
        }, o = [0, 4, 2, 1], a = [8, 8, 4, 2], s = 0, u = 0; u < 4; u++) {
          for (var l = o[u]; l < n; l += a[u]) {
            i(l, s), s++;
          }
        }return r;
      };s.leftPos = r.readUnsigned(), s.topPos = r.readUnsigned(), s.width = r.readUnsigned(), s.height = r.readUnsigned();var l = e(r.readByte());s.lctFlag = l.shift(), s.interlaced = l.shift(), s.sorted = l.shift(), s.reserved = l.splice(0, 2), s.lctSize = t(l.splice(0, 3)), s.lctFlag && (s.lct = o(1 << s.lctSize + 1)), s.lzwMinCodeSize = r.readByte();var h = a();s.pixels = n(s.lzwMinCodeSize, h), s.interlaced && (s.pixels = u(s.pixels, s.width)), _i2.img && _i2.img(s);
    },
        h = function t() {
  ...
  function i(t) {
    ...
    return l[t] || (l[t] = a(t)), l[t];
  }function a(i) {
    var o = 0,
        a = 0,
        s = 0,
        u = { framesProcessed: 0, header: null, frameInfos: [], block: null, canvases: [], callbacks: [], processNextFrame: function processNextFrame() {
        var t = this.framesProcessed,
          ...
          var n = document.createElement("canvas");n.style.position = "absolute", n.style.left = 0, n.style.top = 0, n.width = this.header.width, n.height = this.header.height;var i = n.getContext("2d");i.webkitImageSmoothingEnabled = !1, i.imageSmoothingEnabled = !1, i.msImageSmoothingEnabled = !1, this.canvases[t] = n, t > 0 && i.drawImage(this.canvases[t - 1], 0, 0);var o = i.getImageData(0, 0, n.width, n.height),
              u = this,
              l = this.processNextFrame.bind(this);r.send(e, o, this.header, function (t, e) {
            i.putImageData(t, 0, 0), u.callbacks[e.frame] && u.callbacks[e.frame](), s = e.frame, u.frameInfos[e.frame].ready = !0, l();
          }), a = this.framesProcessed, this.framesProcessed++;
        }
      }, hdr: function hdr(t) {
        this.header = t;
      }, gce: function gce(t) {
        ...
        if (this.block && e.time > o) {
          a = (a + 1) % this.frameInfos.length;var t = this.frameInfos[this.frameInfos.length - 1].cycleTime;o = Math.floor(e.time / t) * t + this.frameInfos[a].cycleTime;
        }return Math.min(a, s);
      }, eof: function eof(t) {
        this.block = t, this.processNextFrame();
      } };return t.loadAsync(i, function (t) {
      n.parseGIF(new n.Stream(t), u);
    }, !0), u;
  }function s() {
    l = {};
  }function u() {}var l = {};return u.getGif = o, u.isGif = i, t.onDestroy(s), u;
  ...
  function r() {
    ...
    var r = -Math.atan2(e - g.position.z, t - g.position.x) - Math.PI / 2;return b.setFromAxisAngle(A, r), b.multiply(I), b.toArray(w);
  }function c() {
    ...
    var t = innerWidth,
      ...
      I = new t.Quaternion().setFromAxisAngle(new t.Vector3(1, 0, 0), -Math.PI / 2);return p.setCamera3d = n, p.isCamera3d = s, p.getCamera = r, p.setCameraPosition = h, p.getCameraPosition = l, p.getCameraQuaternionData = o, p.shadowQuatArray = f, p.quaternions = c(), a(), n(!0), e.addLoop(d), p;
  ...
  function r() {
    ...
    return this.position.set(t, e, r), this.size[0] = n, this.size[1] = i, this.hasQuaternionArray = null !== o, this.hasQuaternionArray && (this.quaternionArray[0] = o[0], this.quaternionArray[1] = o[1], this.quaternionArray[2] = o[2], this.quaternionArray[3] = o[3]), this.light = a, this.img = s, this;
  ...
  function r(t) {
    ...
    if (g) {
      var t = g.getContext("2d"),
          r = a();y = Math.max(0, y + (r - y) / 10), r >= 1 && (y = 1, e.removeLoop(s)), t.fillRect(10, 10, (g.width - 20) * y, g.height - 20), r >= 1 && m && setTimeout(m, 100);
    }
  }function u() {
    if (!g) {
  ...
  function o(e, r) {
    if (!x[e] && r) {
      var n = x[e] = document.createElement("canvas");if (n.setAttribute("url", e), 0 === e.indexOf("tex-")) {
        n.width = n.height = q;var i = parseInt(e.split("-").pop()),
            o = new t.Texture(n);o.magFilter = t.NearestFilter, o.minFilter = t.LinearMipMapLinearFilter, n.addEventListener("update", g), I[i] = o, n.setAttribute("texture", i.toString()), n.style.position = "absolute", n.style.left = 0, n.style.top = 0;
    ...
    }var p = t[0];i = o(e + ":" + p, !0);var g = p.split("x");if (2 !== g.length || isNaN(parseInt(g[0])) || isNaN(parseInt(g[1]))) {
      if (r.isGif(p)) {
    ...
    if (b[t] && b[t].cut[e] && b[t].cut[e].ready) return b[t];var r = u(t.split("|"), e),
      ...
      F[r.getAttribute("url")] = n, r.addEventListener("update", p), r.dispatchEvent(s("update"));var a = n.x / q,
          l = n.y / q,
          h = r.width / q,
          f = r.height / q,
          c = D.attributes.uv.array,
          d = [a, 1 - l - f, a + h, 1 - l];o.animated = "true" === r.getAttribute("animated"), o.cut[e].baseUrl = o.baseUrl = r.getAttribute("base-url"), o.cut[e].tex = n.tex, o.cut[e].uv = new Float32Array(c.length);for (var g = 0; g < c.length; g++) {
        o.cut[e].uv[g] = d[2 * c[g] + g % 2];
    ...
    if (n < 500) return void s(t, r, r + n - 1, i);var u = e(t, r, n);if (!u.inOrder) {
      var d = u.min,
        ...
        var y, m;for (h.fill(0), h[c] = 1, y = 0; y < n; y++) {
          ...
          m = Math.floor((c - 1) * (f(t[v]) - d) / g);var b = l[m] + --h[m];for (a(t, v, b); !h[x];) {
            x++;
          }v = l[x];
        }for (y = 0; y < c; y++) {
          h[y] = l[y + 1] - l[y];
  ...
  function u() {
    ...
    this.render();for (var t = this.images, e = this.imageOrder, r = this.imageCount, n = this.mesh.geometry, i = n.attributes.quaternion.array, o = n.attributes.spot.array, a = n.attributes.position.array, s = n.attributes.tex.array, u = n.attributes.light.array, l = n.attributes.uv.array, h = n.index.array, f = !1, c = !1, d = !1, p = !1, g = !1, y = !1, m = 0; m < r; m++) {
      ...
      }v.positionDirty && (o.set(v.spotArray, 12 * b), v.positionDirty = !1, c = !0), v.verticesDirty && (a.set(v.vertices, 12 * b), v.verticesDirty = !1, p = !0), v.uvDirty && (l.set(v.uv, 8 * b), v.uvDirty = !1, g = !0), v.texDirty && (s.fill(v.tex, 4 * b, 4 * b + 4), v.texDirty = !1, d = !0), v.lightDirty && (u.fill(v.light, 4 * b, 4 * b + 4), v.lightDirty = !1, y = !0);
    }for (var A = 0; A < r; A++) {
      h.set(e[A].indexArray, 6 * A);
    }0 === n.drawRange.start && n.drawRange.count === r * x.index.count || n.setDrawRange(0, r * x.index.count), y && (n.attributes.light.needsUpdate = !0), f && (n.attributes.quaternion.needsUpdate = !0), c && (n.attributes.spot.needsUpdate = !0), p && (n.attributes.position.needsUpdate = !0), d && (n.attributes.tex.needsUpdate = !0), g && (n.attributes.uv.needsUpdate = !0), n.index.needsUpdate = !0, this.clear();
  }function m() {
  ...
  function i() {}function o(e, r, n) {
    ...
    for (var e = this.options.x, r = this.options.y, n = this.options.width, i = this.options.height, o = n * i, a = this.options.count || 1, s = o * a, u = 0; u < s; u++) {
      var l = e + u % n,
  ...
  }o.prototype.pos = null, o.prototype.size = null, o.prototype.getSprite = i, o.prototype.forEach = a, o.prototype.options = null, o.prototype.getSprite = i, o.prototype.isCollection = !0;var f = [];return o.createSpriteCollection = h, t.onDestroy(s), o;

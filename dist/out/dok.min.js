  ...
  function e(t) {
    if (void 0 === t.target.attributes.tap) {
      var e = t.changedTouches;if (e) for (var r = 0; r < e.length; r++) {
        var n = e[r];p[n.identifier] = n.pageX, g[n.identifier] = n.pageY;
      } else f.x = t.pageX, f.y = t.pageY;y = !0;for (var r = 0; r < c.length; r++) {
        c[r](null, null, !0, t.pageX, t.pageY);
      }
    }t.preventDefault();
  }function r(t) {
    var e = !1;if (t.changedTouches) {
      for (var r = 0; r < t.changedTouches.length; r++) {
        delete p[touch.identifier], delete g[touch.identifier];
      }for (var r in p) {
        e = !0;
      }
    }for (var r = 0; r < c.length; r++) {
      c[r](null, null, e, t.pageX, t.pageY);
    }y = !1, t.preventDefault();
  }function n(t) {
    t = t || event;var e = t.changedTouches;if (e) {
      if (y) {
        for (var r = 0, n = 0, i = 0; i < e.length; i++) {
          var a = e[i];r += a.pageX - p[a.identifier], n += a.pageY - g[a.identifier], p[a.identifier] = a.pageX, g[a.identifier] = a.pageY;
        }for (var i = 0; i < c.length; i++) {
          c[i](r, n, !0, t.pageX, t.pageY);
        }
      }
    } else {
      var o = "buttons" in t && 1 === t.buttons || 1 === (t.which || t.button);if (o && y) {
        var s = t.pageX,
            u = t.pageY,
            r = s - f.x,
            n = u - f.y;f.x = s, f.y = u;for (var i = 0; i < c.length; i++) {
          c[i](r, n, !0, t.pageX, t.pageY);
        }
      } else {
        y = !1;for (var i = 0; i < c.length; i++) {
          c[i](r, n, !1, t.pageX, t.pageY);
        }
      }
    }t.preventDefault();
  }function i(t) {
    t = t || event;for (var e = 0; e < d.length; e++) {
      d[e](t.deltaX, t.deltaY);
    }
  }function a(t) {
    u(), s(), c.push(t);
  }function o(t) {
    ...
    c = [], d = [], u();
  }function h() {}var f = { x: 0, y: 0 },
      c = [],
      d = [],
      p = {},
      g = {},
      y = !1;return h.setOnTouch = a, h.setOnWheel = o, t.onDestroy(l), h;

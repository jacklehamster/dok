...
var _typeof = "function" == typeof Symbol && "symbol" == _typeof2(Symbol.iterator) ? function (t) {
  ...
  function r() {
    ...
    t.position.set(e, r, n), t.size[0] = i, t.size[1] = a, t.hasQuaternionArray = null !== o, t.hasQuaternionArray && (t.quaternionArray[0] = o[0], t.quaternionArray[1] = o[1], t.quaternionArray[2] = o[2], t.quaternionArray[3] = o[3]), t.light = s, t.img = u;
  }r.prototype.position = null, r.prototype.size = null, r.prototype.hasQuaternionArray = !1, r.prototype.quaternionArray = null, r.prototype.light = 1, r.prototype.img = -1, r.prototype.offset = null;var i = new e(r);return r.create = function (t, e, r, a, o, s, u, l) {
  ...
  function t(t) {
    ...
    if (n < 200) return void s(t, r, r + n - 1, i);var u = e(t, r, n);if (!u.inOrder) {
      var d = u.min,
        ...
        var y,
            m,
            v = Math.min(n, c);for (y = 0; y < v; y++) {
          h[y] = 0;
        }for (h[v] = 1, y = 0; y < n; y++) {
          m = Math.floor((v - 1) * (f(t[y + r]) - d) / g), h[m]++;
        }for (y = 0; y < v; y++) {
          l[y] = 0;
        }for (l[v] = n, l[0] = r, y = 1; y < v; y++) {
          l[y] = l[y - 1] + h[y - 1];
        }for (var x = r, w = 0; w < v;) {
          m = Math.floor((v - 1) * (f(t[x]) - d) / g);var b = l[m] + --h[m];for (o(t, x, b); !h[w];) {
            w++;
          }x = l[w];
        }for (y = 0; y < v; y++) {
          h[y] = l[y + 1] - l[y];
